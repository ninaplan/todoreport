...
- **할일 보관** — 🔜 **인박스 길 A 진행 중** (2026-09-10). 날짜 제거(편집)→노션 date 비움, `+`에서 날짜 없이 저장→인박스 생성까지 완료. **인박스 목록/탭 UI는 미구현**. 카테고리 숨김과는 별개
...
| **할일 보관 (인박스)** | 진행 중 | 길 A: 날짜 제거·인박스 생성(POST inbox) 완료. 다음: 인박스 목록/탭 UI. → `V2-IDEAS.md` |
